...
import { X, Calendar, ArrowLeft, Search, ChevronLeft, ChevronRight, Menu, HelpCircle } from "lucide-react";
...
export default function DayRecordChecker() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col p-00 m-0">
        ...
        <div className="max-w-6xl mx-auto">
          <div className="flex items-center justify-between px-4 h-14">
            <div className="flex items-center">
              ...
              <h1 className="text-xl font-normal ml-3 text-gray-800">Day Records</h1>
            </div>
      ...
      {/* Mobile Menu */}
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-10 bg-black bg-opacity-50 lg:hidden" onClick={() => setIsMobileMenuOpen(false)}>
      ...
      <main className="flex-1 max-w-3xl mx-auto w-full px-4 py-6">
        ...
        <section className="bg-white rounded-lg shadow mb-6 overflow-hidden">
          <div className="bg-blue-50 px-6 py-4 border-b border-blue-100">
            <h2 className="text-lg font-medium text-gray-800">Check Day's Record</h2>
          </div>
      ...
      {showDayPopup && dailyData && (
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4 backdrop-blur-sm" onClick={() => setShowDayPopup(false)}>
              ...
              <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 flex justify-between items-center">
                ...
                <span 
                  className={`text-lg font-medium ${
                    (dailyData.totalIncome || 0) - (dailyData.totalExpense || 0) >= 0
                      ? "text-green-600"
                      : "text-red-600"
                  }`}
                >
                  ₹{((dailyData.totalIncome || 0) - (dailyData.totalExpense || 0)).toLocaleString()}
                </span>
              </div>
